...
public class ComponentSelection extends JFrame {
	...
	public ComponentSelection() {
		...
		dropList1.setBounds(134, 45, 162, 21);
		contentPane.add(dropList1);
		
		JComboBox dropList2 = new JComboBox();
		dropList2.setBounds(134, 95, 162, 21);
		contentPane.add(dropList2);
		
		JComboBox dropList3 = new JComboBox();
		dropList3.setBounds(134, 145, 162, 21);
		contentPane.add(dropList3);
		
		JComboBox dropList4 = new JComboBox();
		dropList4.setBounds(134, 195, 162, 21);
		contentPane.add(dropList4);
		
		JComboBox dropList5 = new JComboBox();
		dropList5.setBounds(134, 245, 162, 21);
		contentPane.add(dropList5);
		
		JComboBox dropList6 = new JComboBox();
		dropList6.setBounds(134, 295, 162, 21);
		contentPane.add(dropList6);
		
		JComboBox dropList7 = new JComboBox();
		dropList7.setBounds(134, 345, 162, 21);
